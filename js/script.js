...
document.getElementsByClassName("but")[1].style.background ='lightgray';
document.getElementsByClassName("sect")[2].style.display ='none';
document.getElementsByClassName("but")[2].style.background ='lightgray';
document.getElementsByClassName("sect")[3].style.display ='none';
document.getElementsByClassName("but")[3].style.background ='lightgray';
...
document.getElementsByClassName("but")[0]  .style.background = 'lightgray';
